...
var
	...
	SPanimScript/DemoScript = new('DemoScript.txt')
...
IntroDisplay
	...
	New()
		...
		var/AnimState/FadeIn = DemoScript.GetState("IntroFadeIn")
		var/AnimState/FadeOut = DemoScript.GetState("IntroFadeOut")
		TO1.InsertAnimationState("FadeIn",FadeIn)
		TO1.InsertAnimationState("FadeOut",FadeOut)
		TO2 = new("Presentation",IS,0)
		TO2.InsertAnimationState("FadeIn",FadeIn)
		TO2.InsertAnimationState("FadeOut",FadeOut)
...
MainMenuDisplay
	...
	New()
		...
		// AS2.AddStage(AS2_S2)
		TO1 = new("SByIo",S1,0)
		var/AnimState/AS = DemoScript.GetState("SByIoTextFX")
		TO1.InsertAnimationState("FX",AS)
		// TO1 = new(MMTxt1)
		TO2 = new("Demo!",S2,0)
		AS = DemoScript.GetState("DemoTextFX")
		TO2.InsertAnimationState("FX",AS)
		// TO2 = new(MMTxt2)
		// TO1.SetIconState("FX")
		TO1.SetScreenLoc(9,24,13,0)
		// TO2.SetIconState("FX")
		TO2.SetScreenLoc(8,20,12,14)
		Menu = new(S3,HMS1,0,12,'DemoCursor.dmi',0,MVSPACING,null)
...
HostMenuDisplay
	...
	New(client/C)
		...
		Menu = new(S3,HMS1,0,12,null,0,MVSPACING,null)
...
Menu2Display
	...
	New()
		...
		Menu = new(S7,HMS2,0,12,null,0,MVSPACING,null)
		Menu.AddItem("Return to Main Menu","EnterMainMenu")
...
ItemTypesDisplay
	...
	New()
		...
		ITO1 = new("Item Type 1",S3,S7)
		ITO2 = new("Item Type 2",S3,HMS1)
		ITO3 = new("Item Type 3",S3,HMS3)
		ITO4 = new("Item Type 4",S3,HMS4)
		ITO5 = new("Item Type 5",S3,S3,null,'DemoCursor.dmi')
		ITO6 = new("Return to Main Menu",S2,S8,"EnterMainMenu")
...
That is very nice!"},S3,0)
		ITO = new("Return to Main Menu",S9,HMS5,"EnterMainMenu")
...
NewMenuDisplay
	...
	New()
		...
		Menu = new(S3,S3,12,0,'DemoCursor.dmi',1,MHSPACING,null)
